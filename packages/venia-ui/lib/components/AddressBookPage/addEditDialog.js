...
const AddEditDialog = props => {
    ...
    const districtLabel = formatMessage({
        id: 'global.district',
    ...
    const isDefaultShipping = formProps && formProps.initialValues && formProps.initialValues.default_shipping;
    return (
        <Dialog
        ...
        >
            ...
            <div className={classes.root}>
                ...
                <div className={classes.country}>
                    <Field id="country" label={countryLabel}>
                ...
                <div className={classes.district}>
                    <Field id="district" label={districtLabel}>
                        <TextInput field="district" validate={isRequired} />
                    </Field>
                </div>
