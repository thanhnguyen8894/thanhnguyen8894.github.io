...
import { ArrowLeft as ArrowLeftIcon, ArrowRight as ArrowRightIcon, X as CloseIcon } from 'react-feather';
...
const NavHeader = props => {
    ...
    const arrowIcon = rtl ? ArrowRightIcon : ArrowLeftIcon;
    ...
    const backIcon = isTopLevelMenu ? CloseIcon : arrowIcon;
