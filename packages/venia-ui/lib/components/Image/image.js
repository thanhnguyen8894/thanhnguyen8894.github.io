...
const Image = props => {
    ...
    const containerClass = `
        ${classes.root}
        ${classes.container}
        ${heightParrentImageAuto ? classes.heightParrentImageAuto : ''}
        ${customMobileProductDetails ? classes.customMobileProductDetails : ''}
    `;
