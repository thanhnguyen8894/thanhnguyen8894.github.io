...
// export const CUSTOMER_INVOICE_PDF = gql`
//     mutation customerInvoicePdf($orderNumber: String!) {
//         customerInvoicePdf(order_number: $orderNumber) {
//             file_name
//             content
//             content_type
//         }
...
export default {
    ...
    // getCustomerInvoicePdf: CUSTOMER_INVOICE_PDF
};
