        ...
        >
            <div className={navigationWrapperClass} ref={navigationRef}>
                <TabList
                    ...
                    className={`${navigationClass} ${classes.listTabHeader}`}
                >
                    {tabHeaders}
                </TabList>
            </div>
 ...
 * @property {Number} selectedIndex Index of the tab selected
 * @property {Function} onSelect Called every time a tab is about to change (index: number, lastIndex: number, event: Event) => ?boolean
